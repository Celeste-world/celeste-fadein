...
この機能は /log/ の全体ダウンロードとは役割を分けます。

ダウンロード前には、登録メールアドレス確認を必須にします。
...
スマホ表示総点検
29. 今後の優先タスク
優先度1：Archive Search more

/voyage-archive/ の検索結果は現在最大200件。

長期利用に備え、将来的に以下を追加します。

Search more
さらに読み込む
検索結果の追加取得
優先度2：Monthly Summary 軽強化
